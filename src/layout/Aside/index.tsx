...
const Aside = () => {
    return (
        <div className="left-0 top-0 z-[101] flex justify-between overflow-hidden bg-asideBg xs:absolute xs:w-full lg:fixed lg:h-screen lg:w-[96px] lg:flex-col lg:rounded-r-2xl">
